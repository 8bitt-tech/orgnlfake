...
import { TrendingUp, Users, Eye, MapPin, Globe, User, Activity } from "lucide-react";
...
export function TiktokAnalytics({ analytics, username }: TiktokAnalyticsProps) {
  return (
    <div className="w-full max-w-5xl mx-auto p-6 rounded-2xl shadow-sm border border-white/10 bg-black/20 backdrop-blur-sm font-sans">
      ...
      <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
        <div className="flex items-center space-x-3">
          <div className="p-3 bg-gradient-to-tr from-cyan-400 to-pink-500 rounded-xl text-white shadow-md flex items-center justify-center">
          ...
          <div>
            <h2 className="text-xl font-bold text-white">TikTok Overview</h2>
            <p className="text-sm text-[#a0a0a0]">
              Estimated analytics for @{username}
            </p>
          </div>
        </div>
        <select className="px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-sm text-[#a0a0a0] outline-none focus:ring-2 focus:ring-cyan-500 cursor-pointer">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="p-5 rounded-xl border border-white/10 bg-white/5">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-sm font-medium text-[#a0a0a0]">Total Views</h3>
      ...
      <div className="h-[350px] w-full mt-4">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            <defs>
              {/* Gradient for Reach (Cyan) */}
              <linearGradient id="colorReachTk" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#06b6d4" stopOpacity={0.3} />
                <stop offset="95%" stopColor="#06b6d4" stopOpacity={0} />
              </linearGradient>
              {/* Gradient for Followers (Pink) */}
              <linearGradient id="colorFollowersTk" x1="0" y1="0" x2="0" y2="1">
